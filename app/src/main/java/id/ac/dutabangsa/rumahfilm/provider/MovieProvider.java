package id.ac.dutabangsa.rumahfilm.provider;
...
import id.ac.dutabangsa.rumahfilm.database.MovieHelper;

import static id.ac.dutabangsa.rumahfilm.database.MovieContract.AUTHORITY;
import static id.ac.dutabangsa.rumahfilm.database.MovieContract.CONTENT_URI;
...
public class MovieProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(AUTHORITY,
                MovieContract.MovieColumns.TABEL_MOVIE, MOVIE);
